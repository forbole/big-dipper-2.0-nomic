...
- Fixed validators page ([\#14](https://github.com/forbole/big-dipper-2.0-nomic/pull/14))
- Fixed blocks, validators and txs display ([\#15](https://github.com/forbole/big-dipper-2.0-nomic/pull/15))
